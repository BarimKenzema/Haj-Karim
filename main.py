...
telegram_channels = json_load('telegram_channels.json')
...
# THIS IS THE FIX telegram_proxies_channel = []
...
invalid_array_channels = json_load('invalid telegram_channels.json')
...
subscription_links = json_load('subscription_links.json')
...
# with open('./subscription_links.json', 'w') as subscription_file:
...
![GitHub last commit (by committer)](https://img.shields.io/github/last-commit/konabalan/TelConCol?label=Last%20Commit&color=%2338914b)
![GitHub](https://img.shields.io/github/license/konabalan/TelConCol?label=License&color=yellow)
![GitHub Repo stars](https://img.shields.io/github/stars/konabalan/TelConCol?label=Stars&color=red&style=flat)
![GitHub forks](https://img.shields.io/github/forks/konabalan/TelConCol?label=Forks&color=blue&style=flat)
...
stats = """## Stats
[![Stars](https://starchart.cc/konabalan/TelConCol.svg?variant=adaptive)](https://starchart.cc/konabalan/TelConCol)"""
