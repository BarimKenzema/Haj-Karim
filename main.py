...
# VERSION 45.0: Added Flow Detection + Premium Config Filtering
...
print("--- GITHUB COLLECTOR v45.0 (Flow Detection + Premium Filtering) START ---")
...
def main():
    ...
    for item in processed:
        ...
        # NEW: Categorize by flow
        flow = attrs.get('flow')
        if flow:
            flow_key = flow.replace('-', '_')  # Sanitize for filename
    ...
    # NEW: Save flow-based categories
