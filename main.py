...
# VERSION 44.0: Optimized with Database Cleanup & Better Git Handling
...
print("--- GITHUB COLLECTOR v44.0 (Optimized with Cleanup) START ---")
...
MAX_DB_FILES_TO_KEEP = 4  # Only keep the 2 most recent database files
